                ...
                switch (i.mode) {
                  ...
                  case 19:
                    for (; i.have < i.nlen + i.ndist; ) {
                      for (
                        ;
                        (Z =
                          ((D = i.lencode[w & ((1 << i.lenbits) - 1)]) >>> 16) &
                          255),
                          (B = 65535 & D),
                          !((E = D >>> 24) <= k);
                  ...
                  case 23:
                    for (
                      ;
                      (Z =
                        ((D = i.distcode[w & ((1 << i.distbits) - 1)]) >>> 16) &
                        255),
                        (B = 65535 & D),
                        !((E = D >>> 24) <= k);
          ...
          function c(e) {
            ...
            if (
              ...
              t.dictionary &&
                ...
                t.raw &&
                  (i = n.inflateSetDictionary(this.strm, t.dictionary)) !==
                    o.Z_OK))
            )
              throw new Error(s[i])
          }
