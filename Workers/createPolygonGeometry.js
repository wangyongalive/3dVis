define([
  ...
  function Q(o) {
    ...
    if (n.st || n.normal || n.tangent || n.bitangent || l) {
      ...
      let P
      n.normal &&
        (P = f && y && !m ? a.attributes.normal.values : new Float32Array(p))
      ...
      if (0 !== h) {
        ...
        (V = t.Matrix3.clone(t.Matrix3.IDENTITY, V)),
        ...
        if (n.normal || n.tangent || n.bitangent || l) {
          ...
          if (m) {
            if (r + 3 < p) {
              ...
              t.Cartesian3.equalsEpsilon(e, a, s.CesiumMath.EPSILON10) &&
                (G = !0)
            }
            ;(n.tangent || n.bitangent) &&
              ((v = d.geodeticSurfaceNormal(a, v)),
              n.tangent &&
                (E = t.Cartesian3.normalize(t.Cartesian3.cross(v, A, E), E)))
          } else
              ...
              (n.tangent || n.bitangent) &&
                (f &&
                  ...
                  (S = t.Cartesian3.normalize(
                    t.Matrix3.multiplyByVector(Q, S, S),
                    S
                  )),
                  n.bitangent &&
                ...
                (E = t.Cartesian3.normalize(
                  t.Matrix3.multiplyByVector(Q, E, E),
                  E
                )),
                n.bitangent &&
                  (v = t.Cartesian3.normalize(t.Cartesian3.cross(A, E, v), v)))
          n.normal &&
            (o.wall
  ...
  function ee(e, t, o, i) {
    ...
    for (let t = 0; t < r; t++) {
      ...
      ;(i.westOverIDL = Math.min(i.westOverIDL, c)),
        (i.eastOverIDL = Math.max(i.eastOverIDL, c))
    }
  }
  const te = []
  function oe(e, t, o, i, n, r, a, s, l) {
    ...
    let m
    if (r || a) {
      const i = g.PolygonGeometryLibrary.createGeometryFromPositions(
          e,
          t,
          o,
          n,
      ...
      if (r && a) {
        const e = c.concat(c)
        ;(h = e.length / 3),
          (f = y.IndexDatatype.createTypedArray(h, 2 * d.length)),
          f.set(d)
        const t = d.length,
          o = h / 2
        for (m = 0; m < t; m += 3) {
        ...
        for (
          h = c.length / 3,
            f = y.IndexDatatype.createTypedArray(h, d.length),
            m = 0;
          m < d.length;
          m += 3
        )
  ...
  ;(ie.fromPositions = function (t) {
    ...
    (ie.pack = function (o, i, n) {
      return (
        ...
        (n = g.PolygonGeometryLibrary.packPolygonHierarchy(
          o._polygonHierarchy,
          i,
          n
        )),
  ...
  return (
    ...
    (ie.createGeometry = function (t) {
      ...
      ;(D.attributes.position.values = new Float64Array(
