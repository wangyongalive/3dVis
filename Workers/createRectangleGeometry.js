define([
  ...
  function S(a, o) {
    ...
    let B, U, Y
    if (g.normal) {
      for (U = x.attributes.normal.values, I.set(U), A = 0; A < F; A++)
        U[A] = -U[A]
    ...
    if (q) {
      ...
      p === n.GeometryOffsetAttribute.TOP
        ...
        : ((Y = p === n.GeometryOffsetAttribute.NONE ? 0 : 1),
          (e = n.arrayFill(e, Y))),
    ...
    q &&
      !lt &&
      ((Y = p === n.GeometryOffsetAttribute.ALL ? 1 : 0),
      (it = n.arrayFill(it, Y)))
    let ut = 0,
      ct = 0,
      mt = 0,
        ...
        for (let f = 0; f < o; f += 6) {
          ...
          e.Cartesian3.equalsEpsilon(b, h, r.CesiumMath.EPSILON10) && (p = !0),
            (n.tangent || n.bitangent) &&
              ...
              n.tangent &&
                (g = e.Cartesian3.normalize(e.Cartesian3.cross(d, y, g), g))),
            n.normal &&
              ((i[u++] = y.x),
              (i[u++] = y.y),
              (i[u++] = y.z),
            ...
            t.defined(this._textureCoordinateRotationPoints) ||
              (this._textureCoordinateRotationPoints = (function (t) {
                ...
                const c = i[0],
                  ...
                  d = new Array(6)
                return (
                  e.Cartesian2.pack(c, d),
                  e.Cartesian2.pack(m, d, 2),
                  e.Cartesian2.pack(p, d, 4),
                  d
                )
              })(this)),
