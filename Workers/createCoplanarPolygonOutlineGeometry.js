define([
  ...
  function k(e) {
    const t = (e = a.defaultValue(e, a.defaultValue.EMPTY_OBJECT))
      .polygonHierarchy
    ;(this._polygonHierarchy = t),
      (this._workerName = 'createCoplanarPolygonOutlineGeometry'),
      (this.packedLength =
        p.PolygonGeometryLibrary.computeHierarchyPackedLength(t) + 1)
  }
  ;(k.fromPositions = function (e) {
    ...
    (k.pack = function (e, t, n) {
      return (
        ...
        (t[
          (n = p.PolygonGeometryLibrary.packPolygonHierarchy(
            e._polygonHierarchy,
            t,
            n
          ))
  ...
  return (
    (k.unpack = function (e, t, n) {
      ...
      const r = e[t]
      return (
        a.defined(n) || (n = new k(_)),
        (n._polygonHierarchy = o),
        (n.packedLength = r),
        n
      )
    }),
    (k.createGeometry = function (o) {
      ...
      let a = r.positions
      if (
        ((a = e.arrayRemoveDuplicates(a, n.Cartesian3.equalsEpsilon, !0)),
        a.length < 3)
      )
        return
