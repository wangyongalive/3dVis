define([
...
], function (t, e, a, n, i, r, o, s, f, u) {
  'use strict'
  function l(t) {
    this.planes = r.defaultValue(t, [])
  }
  const c = [new a.Cartesian3(), new a.Cartesian3(), new a.Cartesian3()]
  a.Cartesian3.clone(a.Cartesian3.UNIT_X, c[0]),
    a.Cartesian3.clone(a.Cartesian3.UNIT_Y, c[1]),
    a.Cartesian3.clone(a.Cartesian3.UNIT_Z, c[2])
  const h = new a.Cartesian3(),
    p = new a.Cartesian3(),
    d = new f.Plane(new a.Cartesian3(1, 0, 0), 0)
  function m(t) {
  ...
  ;(l.fromBoundingSphere = function (t, e) {
    ...
    for (let t = 0; t < n; ++t) {
      ...
      let n = i[f],
        u = i[f + 1]
      r.defined(n) || (n = i[f] = new a.Cartesian4()),
        r.defined(u) || (u = i[f + 1] = new a.Cartesian4()),
        a.Cartesian3.multiplyByScalar(e, -s, h),
        a.Cartesian3.add(o, h, h),
        (n.x = e.x),
        (n.y = e.y),
        (n.z = e.z),
        (n.w = -a.Cartesian3.dot(e, h)),
        a.Cartesian3.multiplyByScalar(e, s, h),
        a.Cartesian3.add(o, h, h),
        (u.x = -e.x),
        (u.y = -e.y),
        (u.z = -e.z),
        (u.w = -a.Cartesian3.dot(a.Cartesian3.negate(e, p), h)),
        (f += 2)
    }
    return e
  }),
    (l.prototype.computeVisibility = function (t) {
      ...
      for (let i = 0, r = a.length; i < r; ++i) {
        const r = t.intersectPlane(f.Plane.fromCartesian4(a[i], d))
    ...
    (l.prototype.computeVisibilityWithPlaneMask = function (t, a) {
      ...
      for (let r = 0, o = i.length; r < o; ++r) {
        ...
        const s = t.intersectPlane(f.Plane.fromCartesian4(i[r], d))
        if (s === e.Intersect.OUTSIDE) return l.MASK_OUTSIDE
  ...
  ;(m.prototype.computeCullingVolume = function (t, e, n) {
    const i = this._cullingVolume.planes,
      o = this.top,
      s = this.bottom,
      f = this.right,
      u = this.left,
    ...
    let m = i[0]
    return (
      r.defined(m) || (m = i[0] = new a.Cartesian4()),
      (m.x = h.x),
      (m.y = h.y),
      (m.z = h.z),
      ...
      (m = i[1]),
      r.defined(m) || (m = i[1] = new a.Cartesian4()),
      (m.x = -h.x),
      (m.y = -h.y),
      (m.z = -h.z),
      (m.w = -a.Cartesian3.dot(a.Cartesian3.negate(h, w), d)),
      a.Cartesian3.multiplyByScalar(n, s, d),
      a.Cartesian3.add(p, d, d),
      (m = i[2]),
      r.defined(m) || (m = i[2] = new a.Cartesian4()),
      (m.x = n.x),
      (m.y = n.y),
      (m.z = n.z),
      ...
      a.Cartesian3.add(p, d, d),
      (m = i[3]),
      r.defined(m) || (m = i[3] = new a.Cartesian4()),
      (m.x = -n.x),
      (m.y = -n.y),
      (m.z = -n.z),
      (m.w = -a.Cartesian3.dot(a.Cartesian3.negate(n, w), d)),
      (m = i[4]),
      r.defined(m) || (m = i[4] = new a.Cartesian4()),
      (m.x = e.x),
      (m.y = e.y),
      (m.z = e.z),
      ...
      (m = i[5]),
      r.defined(m) || (m = i[5] = new a.Cartesian4()),
      (m.x = -e.x),
      (m.y = -e.y),
      (m.z = -e.z),
      (m.w = -a.Cartesian3.dot(a.Cartesian3.negate(e, w), d)),
      this._cullingVolume
    )
  }),
    (m.prototype.getPixelDimensions = function (t, e, a, n, i) {
      C(this)
    ...
    Object.defineProperties(x.prototype, {
      projectionMatrix: {
        get: function () {
          return v(this), this._offCenterFrustum.projectionMatrix
        }
      }
    }),
    (x.prototype.computeCullingVolume = function (t, e, a) {
      return v(this), this._offCenterFrustum.computeCullingVolume(t, e, a)
    }),
    (x.prototype.getPixelDimensions = function (t, e, a, n, i) {
      return v(this), this._offCenterFrustum.getPixelDimensions(t, e, a, n, i)
    }),
    ...
    (x.prototype.equalsEpsilon = function (t, e, a) {
      return (
        !!(r.defined(t) && t instanceof x) &&
        (v(this),
        v(t),
  ...
  ;(M.prototype.computeCullingVolume = function (t, e, n) {
    ...
    let C = i[0]
    return (
      r.defined(C) || (C = i[0] = new a.Cartesian4()),
      (C.x = m.x),
      (C.y = m.y),
      (C.z = m.z),
      ...
      a.Cartesian3.normalize(m, m),
      (C = i[1]),
      r.defined(C) || (C = i[1] = new a.Cartesian4()),
      (C.x = m.x),
      (C.y = m.y),
      (C.z = m.z),
      (C.w = -a.Cartesian3.dot(m, t)),
      ...
      a.Cartesian3.normalize(m, m),
      (C = i[2]),
      r.defined(C) || (C = i[2] = new a.Cartesian4()),
      (C.x = m.x),
      (C.y = m.y),
      (C.z = m.z),
      (C.w = -a.Cartesian3.dot(m, t)),
      ...
      a.Cartesian3.normalize(m, m),
      (C = i[3]),
      r.defined(C) || (C = i[3] = new a.Cartesian4()),
      (C.x = m.x),
      (C.y = m.y),
      (C.z = m.z),
      (C.w = -a.Cartesian3.dot(m, t)),
      (C = i[4]),
      r.defined(C) || (C = i[4] = new a.Cartesian4()),
      (C.x = e.x),
      (C.y = e.y),
      (C.z = e.z),
      ...
      (C = i[5]),
      r.defined(C) || (C = i[5] = new a.Cartesian4()),
      (C.x = m.x),
      (C.y = m.y),
      (C.z = m.z),
    ...
    (P.prototype.getPixelDimensions = function (t, e, a, n, i) {
      return z(this), this._offCenterFrustum.getPixelDimensions(t, e, a, n, i)
    }),
  ...
  function R(t) {
    const n = t.frustum,
      i = t.orientation,
      o = t.origin,
      s = r.defaultValue(t.vertexFormat, u.VertexFormat.DEFAULT),
      f = r.defaultValue(t._drawNearPlane, !0)
    let l, c
    n instanceof P
      ? ((l = 0), (c = P.packedLength))
      : n instanceof x && ((l = 1), (c = x.packedLength)),
      (this._frustumType = l),
  ...
  R.pack = function (t, n, i) {
    ...
    return (
      (n[i++] = o),
      0 === o
        ? (P.pack(s, n, i), (i += P.packedLength))
        : (x.pack(s, n, i), (i += x.packedLength)),
      ...
      u.VertexFormat.pack(t._vertexFormat, n, i),
      (n[(i += u.VertexFormat.packedLength)] = t._drawNearPlane ? 1 : 0),
      n
    )
  }
  const S = new P(),
  ...
  R.unpack = function (t, n, i) {
    n = r.defaultValue(n, 0)
    const o = t[n++]
    let s
    0 === o
      ? ((s = P.unpack(t, n, S)), (n += P.packedLength))
      : ((s = x.unpack(t, n, T)), (n += x.packedLength))
    const f = a.Cartesian3.unpack(t, n, A)
    n += a.Cartesian3.packedLength
    const l = e.Quaternion.unpack(t, n, k)
    n += e.Quaternion.packedLength
    const c = u.VertexFormat.unpack(t, n, D),
      h = 1 === t[(n += u.VertexFormat.packedLength)]
    if (!r.defined(i))
      return new R({
        frustum: s,
        origin: f,
    ...
    return (
      ...
      (i._orientation = e.Quaternion.clone(l, i._orientation)),
      (i._vertexFormat = u.VertexFormat.clone(c, i._vertexFormat)),
      (i._drawNearPlane = h),
      i
    )
  }
  const q = new a.Matrix3(),
    B = new a.Matrix4(),
    L = new a.Matrix4(),
    N = new a.Cartesian3(),
    G = new a.Cartesian3(),
  ...
  const W = new Array(4)
  for (let t = 0; t < 4; ++t) W[t] = new a.Cartesian4()
  ;(R._computeNearFarPlanes = function (t, e, n, i, o, s, f, u) {
    const l = a.Matrix3.fromQuaternion(e, q)
    let c = r.defaultValue(s, N),
      h = r.defaultValue(f, G),
    ...
    const d = a.Matrix4.computeView(t, p, h, c, B)
    let m, C
    if (0 === n) {
      const t = i.projectionMatrix,
        e = a.Matrix4.multiply(t, d, L)
      C = a.Matrix4.inverse(e, L)
    } else m = a.Matrix4.inverseTransformation(d, L)
    r.defined(C)
      ? ((Y[0] = i.near), (Y[1] = i.far))
      : ((Y[0] = 0), (Y[1] = i.near), (Y[2] = i.far))
    for (let e = 0; e < 2; ++e)
      for (let n = 0; n < 4; ++n) {
        let s = a.Cartesian4.clone(J[n], W[n])
        if (r.defined(C)) {
          ...
          a.Cartesian3.multiplyByScalar(s, Y[e] / i, s),
            a.Cartesian3.add(s, t, s)
        } else {
          r.defined(i._offCenterFrustum) && (i = i._offCenterFrustum)
          const t = Y[e],
            n = Y[e + 1]
          ;(s.x = 0.5 * (s.x * (i.right - i.left) + i.left + i.right)),
            (s.y = 0.5 * (s.y * (i.top - i.bottom) + i.bottom + i.top)),
            (s.z = 0.5 * (s.z * (t - n) - t - n)),
            (s.w = 1),
    ...
    (R.createGeometry = function (t) {
      ...
      R._computeNearFarPlanes(u, l, n, f, d)
      let m = 24
      ;(d[m] = d[12]),
        (d[m + 1] = d[13]),
        (d[m + 2] = d[14]),
      ...
      if (
        ...
        const t = r.defined(h.normal) ? new Float32Array(12 * p) : void 0,
          ...
          u = G,
          l = j,
          d = a.Cartesian3.negate(f, U),
          _ = a.Cartesian3.negate(u, Q),
          y = a.Cartesian3.negate(l, K)
        ;(m = 0),
          c && (I(m, t, e, n, s, y, f, u), (m += 12)),
          I(m, t, e, n, s, l, d, u),
          (m += 12),
          I(m, t, e, n, s, d, y, u),
          (m += 12),
