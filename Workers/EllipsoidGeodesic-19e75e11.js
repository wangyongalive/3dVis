define([
  ...
  'use strict'
  function s(t, a, i, n, e, s, o) {
    const r = (function (t, a) {
      return (t * a * (4 + t * (4 - 3 * a))) / 16
    })(t, i)
    return (1 - r) * t * a * (n + r * e * (o + r * s * (2 * o * o - 1)))
  }
  const o = new a.Cartesian3(),
    r = new a.Cartesian3()
  function h(t, i, n, h) {
    a.Cartesian3.normalize(h.cartographicToCartesian(i, r), o),
      a.Cartesian3.normalize(h.cartographicToCartesian(n, r), r),
      (function (t, a, i, n, o, r, h) {
        const c = (a - i) / a,
          d = r - n,
        ...
        let v,
          ...
          U,
          A = d,
          R = e.CesiumMath.TWO_PI,
          w = Math.cos(A),
          b = Math.sin(A)
        do {
          ;(w = Math.cos(A)), (b = Math.sin(A))
          const t = m - H * w
          let a
          ;(S = Math.sqrt(p * p * b * b + t * t)),
            (O = C + f * w),
            (v = Math.atan2(S, O)),
            ...
            isFinite(U) || (U = 0),
            (A = d + s(c, a, q, v, S, O, U))
        } while (Math.abs(A - R) > e.CesiumMath.EPSILON12)
                ...
                (U +
                  (E *
                    (O * (2 * x - 1) -
                      (E * U * (4 * S * S - 3) * (4 * x - 3)) / 6)) /
                    4)),
          P = Math.atan2(p * b, m - H * w),
          T = Math.atan2(M * b, m * w - H)
        ;(t._distance = D),
          (t._startHeading = P),
          (t._endHeading = T),
          (t._uSquared = y)
  ...
  function c(t, i, e) {
    const s = n.defaultValue(e, a.Ellipsoid.WGS84)
    ;(this._ellipsoid = s),
  ...
  Object.defineProperties(c.prototype, {
    ...
    (c.prototype.interpolateUsingSurfaceDistance = function (t, i) {
      const e = this._constants,
        o = e.distanceRatio + t / e.b,
        r = Math.cos(2 * o),
        h = Math.cos(4 * o),
        c = Math.cos(6 * o),
        d = Math.sin(2 * o),
      ...
      let H =
        ...
        o *
          (1 -
            ...
            ((5 * m) / 4 - (115 * _) / 16) * h -
            (29 * _ * c) / 16) +
        (f / 2 - C + (71 * m) / 32 - (85 * _) / 16) * d +
        ((5 * C) / 16 - (5 * m) / 4 + (383 * _) / 96) * u -
        g * ((m - (11 * _) / 2) * d + (5 * _ * u) / 2) +
        ((29 * m) / 96 - (29 * _) / 16) * l +
        (539 * _ * M) / 1536
      const v = Math.asin(Math.sin(H) * e.cosineAlpha),
        O = Math.atan((e.a / e.b) * Math.tan(v))
      H -= e.sigma
      const S = Math.cos(2 * e.sigma + H),
        q = Math.sin(H),
        U = Math.cos(H),
        A = e.cosineU * U,
        R = e.sineU * q,
        w =
          Math.atan2(q * e.sineHeading, A - R * e.cosineHeading) -
          s(e.f, e.sineAlpha, e.cosineSquaredAlpha, H, q, U, S)
      return n.defined(i)
        ? ((i.longitude = this._start.longitude + w),
          (i.latitude = O),
          (i.height = 0),
          i)
