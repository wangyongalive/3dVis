define([
  ...
  ;(r.packedLength = 4),
    ...
    (r.fromPoints = function (t, e) {
      ...
      return (e.x = h), (e.y = d), (e.width = u - h), (e.height = a - d), e
    })
  const d = new h.GeographicProjection(),
  ...
  ;(r.fromRectangle = function (t, n, h) {
    ...
    const o = (n = i.defaultValue(n, d)).project(e.Rectangle.southwest(t, u)),
    ...
    (r.union = function (t, e, n) {
      ...
      return (n.x = h), (n.y = d), (n.width = u - h), (n.height = a - d), n
    }),
