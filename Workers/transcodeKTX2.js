define([
    ...
    toWebGLConstant: function (_, R) {
      switch (_) {
        case e.UNSIGNED_BYTE:
          return t.WebGLConstants.UNSIGNED_BYTE
        case e.UNSIGNED_SHORT:
          return t.WebGLConstants.UNSIGNED_SHORT
        case e.UNSIGNED_INT:
          return t.WebGLConstants.UNSIGNED_INT
        case e.FLOAT:
          return t.WebGLConstants.FLOAT
        case e.HALF_FLOAT:
          return R.webgl2
            ? t.WebGLConstants.HALF_FLOAT
            : t.WebGLConstants.HALF_FLOAT_OES
        case e.UNSIGNED_INT_24_8:
          return t.WebGLConstants.UNSIGNED_INT_24_8
        case e.UNSIGNED_SHORT_4_4_4_4:
          return t.WebGLConstants.UNSIGNED_SHORT_4_4_4_4
        case e.UNSIGNED_SHORT_5_5_5_1:
          return t.WebGLConstants.UNSIGNED_SHORT_5_5_5_1
  ...
  const O = {
    ...
    RGBA_ASTC: t.WebGLConstants.COMPRESSED_RGBA_ASTC_4x4_WEBGL,
    RGB_ETC1: t.WebGLConstants.COMPRESSED_RGB_ETC1_WEBGL,
    RGB8_ETC2: t.WebGLConstants.COMPRESSED_RGB8_ETC2,
    RGBA8_ETC2_EAC: t.WebGLConstants.COMPRESSED_RGBA8_ETC2_EAC,
    RGBA_BC7: t.WebGLConstants.COMPRESSED_RGBA_BPTC_UNORM,
    ...
    toInternalFormat: function (_, R, A) {
      if (!A.webgl2) return _
      if (_ === O.DEPTH_STENCIL) return t.WebGLConstants.DEPTH24_STENCIL8
      if (_ === O.DEPTH_COMPONENT) {
        if (R === T.UNSIGNED_SHORT) return t.WebGLConstants.DEPTH_COMPONENT16
        if (R === T.UNSIGNED_INT) return t.WebGLConstants.DEPTH_COMPONENT24
      }
      if (R === T.FLOAT)
        switch (_) {
          case O.RGBA:
            return t.WebGLConstants.RGBA32F
          case O.RGB:
            return t.WebGLConstants.RGB32F
          case O.RG:
            return t.WebGLConstants.RG32F
          case O.R:
            return t.WebGLConstants.R32F
        }
      if (R === T.HALF_FLOAT)
        switch (_) {
          case O.RGBA:
            return t.WebGLConstants.RGBA16F
          case O.RGB:
            return t.WebGLConstants.RGB16F
          case O.RG:
            return t.WebGLConstants.RG16F
          case O.R:
            return t.WebGLConstants.R16F
        }
      return _
    }
  }
  ...
  let E
  function L(t, A) {
    const e = t.ktx2Buffer,
      O = t.supportedTargetFormats
    let M
    try {
      M = (function (_) {
    ...
    if (0 !== M.layerCount)
      throw new R.RuntimeError('KTX2 texture arrays are not supported.')
    if (0 !== M.pixelDepth)
      throw new R.RuntimeError('KTX2 3D textures are unsupported.')
    ...
    return (
      0 !== M.vkFormat || (163 !== C.colorModel && 166 !== C.colorModel)
          ...
          (function (R, t) {
            ...
            R.vkFormat === B.VK_FORMAT_R8G8B8A8_UNORM
              ...
              : R.vkFormat === B.VK_FORMAT_R16G16B16A16_SFLOAT
                ? (e = T.HALF_FLOAT)
                : R.vkFormat === B.VK_FORMAT_R32G32B32A32_SFLOAT &&
                  (e = T.FLOAT)
        ...
        : (function (t, A, e, T, O, B) {
            const G = new T.KTX2File(t)
            let M = G.getWidth(),
              C = G.getHeight()
            const K = G.getLevels(),
              s = G.getHasAlpha()
            if (!(M > 0 && C > 0 && K > 0))
              throw (
                (G.close(), G.delete(), new R.RuntimeError('Invalid KTX2 file'))
              )
            let F, N
            ...
            if (!G.startTranscoding())
              throw (
                (G.close(),
                G.delete(),
                new R.RuntimeError('startTranscoding() failed'))
              )
            for (let t = 0; t < A.levels.length; ++t) {
              const e = {}
              ;(B[t] = e), (M = A.pixelWidth >> t), (C = A.pixelHeight >> t)
              const T = G.getImageTranscodedSizeInBytes(t, 0, 0, N.value),
                n = new Uint8Array(T),
                K = G.transcodeImage(n, t, 0, 0, N.value, 0, -1, -1)
              if (!_.defined(K))
                throw new R.RuntimeError('transcodeImage() failed.')
              O.push(n.buffer),
                (e[U[0]] = {
                  internalFormat: F,
                  width: M,
