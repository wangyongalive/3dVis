  ...
  return (
    ...
    function (t) {
      ...
      function H(r, t, e) {
        ...
        for (
          var n = t, o = (e -= 2) < 2 * r.length ? e / 2 : r.length, i = 0;
          i < o;
          ++i
        ) {
        ...
        if (!b && (s || c)) {
          if ('function' == typeof fetch && !gr(wr))
            return fetch(wr, { credentials: 'same-origin' })
              .then(function (r) {
                if (!r.ok)
                  throw "failed to load wasm binary file at '" + wr + "'"
      ...
      function Cr() {
        ...
        if ((lr(), o.instantiateWasm))
          try {
            ...
            return (
              T('Module.instantiateWasm callback failed with error: ' + r), !1
            )
          }
        return (
          (b ||
      ...
      function Nr(r, t, e) {
        ...
        if (
          (r ||
            zr('type "' + n + '" must have a positive integer typeid pointer'),
          Wr.hasOwnProperty(r))
        ) {
      ...
      function vt(r, t) {
        if (null === t)
          return this.isReference && zr('null is not a valid ' + this.name), 0
        t.$$ || zr('Cannot pass "' + ae(t) + '" as a ' + this.name),
          t.$$.ptr ||
            zr('Cannot pass deleted object as a pointer of type ' + this.name)
      ...
      function yt(r, t) {
        ...
        if (((e = ht(t.$$.ptr, n, this.registeredClass)), this.isSmartPointer))
          switch (
            (void 0 === t.$$.smartPtr &&
              zr('Passing raw pointer to smart pointer is illegal'),
            this.sharingPolicy)
          ) {
            case 0:
              t.$$.smartPtrType === this
      ...
      function Et(r, t) {
        return (
          (t.ptrType && t.ptr) ||
            Ir('makeClassHandle requires ptr and ptrType'),
      ...
      function Ft(r) {
        ...
        if (void 0 !== e) {
          if (0 === e.$$.count.value)
            return (e.$$.ptr = t), (e.$$.smartPtr = r), e.clone()
          var n = e.clone()
      ...
      function Dt(r, t) {
        ...
        return (
          'function' != typeof e &&
            zr('unknown function pointer with signature ' + r + ': ' + t),
          e
        )
      }
      var Ut = void 0
      ...
      function Mt(r, t) {
        ...
        throw (
          (t.forEach(function r(t) {
            n[t] ||
              Wr[t] ||
              (Er[t] ? Er[t].forEach(r) : (e.push(t), (n[t] = !0)))
          }),
      ...
      function Vt(r, t, e, n, o, i, a, u, s, c, f, l, p) {
        ...
        pt(d, function () {
          ...
          Dr([r, t, e], n ? [n] : [], function (t) {
            var e, o
            ;(t = t[0]),
              (o = n ? (e = t.registeredClass).instancePrototype : ct.prototype)
            var a = jr(d, function () {
                if (Object.getPrototypeOf(this) !== s)
                  throw new Hr("Use 'new' to construct " + f)
            ...
            return (
              (ft[r] = { pointerType: v, constPointerType: y }),
              jt(d, a),
              [h, v, y]
            )
          })
              ...
              return (
                (r.registeredClass.constructor_body[t - 1] = function () {
                  arguments.length !== t - 1 &&
                    ...
                    (u.length = t)
                  for (var r = 1; r < t; ++r)
                    u[r] = n[r].toWireType(s, arguments[r - 1])
        ...
        Nr(r, {
          ...
          toWireType: function (r, t) {
            if ('number' != typeof t && 'boolean' != typeof t)
              throw new TypeError(
                'Cannot convert "' + ae(t) + '" to ' + this.name
              )
            return t
          },
          argPackAdvance: 8,
        ...
        Nr(r, {
          ...
          toWireType: function (r, e) {
            if ('number' != typeof e && 'boolean' != typeof e)
              throw new TypeError(
                'Cannot convert "' + ae(e) + '" to ' + this.name
              )
            if (e < n || e > o)
              throw new TypeError(
                'Passing a number "' +
          ...
          toWireType: function (r, t) {
            ...
            if (((U[i >> 2] = o), e && n)) F(t, i + 4, o + 1)
              ...
              for (var a = 0; a < o; ++a) {
                ...
                u > 255 &&
                  (Je(i),
                  zr('String has UTF-16 code units that do not fit in 8 bits')),
                  (R[i + 4 + a] = u)
              }
        ...
        ;(e = qr(e)),
          ...
          Nr(r, {
            ...
            toWireType: function (r, n) {
              'string' != typeof n &&
                zr('Cannot pass non-string to C++ string type ' + e)
              var i = a(n),
                s = Xe(4 + i + t)
              return (
                (U[s >> 2] = i >> u),
      ...
      function ve(r, t, e, n, o, i) {
        Pr[r] = {
          name: qr(t),
          rawConstructor: Dt(e, n),
          rawDestructor: Dt(o, i),
          fields: []
        }
      }
      ...
      function Me(r) {
        ...
        for (var n = 1; n <= 4; n *= 2) {
          ...
          if (
            ...
            Be(Math.min(e, X(Math.max(r, o), 65536))))
          )
            return !0
        }
        return !1
      ...
      function ze(r, t, e, n) {
        for (var o = 0, i = 0; i < e; i++) {
          for (
            var a = D[(t + 8 * i) >> 2], u = D[(t + (8 * i + 4)) >> 2], s = 0;
            s < u;
            s++
          )
      ...
      ;(o.___embind_register_native_and_builtin_types = function () {
        return (o.___embind_register_native_and_builtin_types = o.asm.Q).apply(
          null,
          arguments
        )
      }),
