define([
  ...
  ;(l.fromRectangle2D = function (e, t, n) {
    ...
    (l.fromRectangleWithHeights2D = function (e, n, o, i, s) {
      ...
      const p = s.center
      return (
        (p.x = a.x + 0.5 * c), (p.y = a.y + 0.5 * d), (p.z = a.z + 0.5 * f), s
      )
    })
  const P = []
  ...
  function Ce() {
    if (
      !r.defined(ne) &&
      ((ne = !1), !ve() && !be() && / Safari\/[\.0-9]+/.test(K.userAgent))
    ) {
  ...
  Ie.lerp = function (e, t, n, r) {
    return (
      (Be = Ie.multiplyByScalar(t, n, Be)),
      (r = Ie.multiplyByScalar(e, 1 - n, r)),
      Ie.add(Be, r, r)
    )
  }
  let Ve = new Ie(),
  ...
  function mt(e, t, n, r, o, i, s) {
    ...
    const l =
      i +
      (r * st.SECONDS_PER_HOUR +
        o * st.SECONDS_PER_MINUTE +
        s * st.SECONDS_PER_MILLISECOND)
  ...
  ;(At.toGregorianDate = function (e, t) {
        ...
        r.defined(t) || 0 === l
          ? r.defined(t) && 0 !== t
            ? ((d = (0.01 * l).toFixed(t).replace('.', '').slice(0, t)),
              `${o.toString().padStart(4, '0')}-${i.toString().padStart(2, '0')}-${s.toString().padStart(2, '0')}T${a.toString().padStart(2, '0')}:${u.toString().padStart(2, '0')}:${c.toString().padStart(2, '0')}.${d}Z`)
            : `${o.toString().padStart(4, '0')}-${i.toString().padStart(2, '0')}-${s.toString().padStart(2, '0')}T${a.toString().padStart(2, '0')}:${u.toString().padStart(2, '0')}:${c.toString().padStart(2, '0')}Z`
    ...
    (At.equalsEpsilon = function (e, t, n) {
      return (
        ...
        e === t ||
          (r.defined(e) &&
            r.defined(t) &&
            Math.abs(At.secondsDifference(e, t)) <= n)
      )
    }),
    ...
    (At.secondsDifference = function (e, t) {
      return (
        (e.dayNumber - t.dayNumber) * st.SECONDS_PER_DAY +
        (e.secondsOfDay - t.secondsOfDay)
      )
    }),
    (At.daysDifference = function (e, t) {
      return (
        e.dayNumber -
        t.dayNumber +
        (e.secondsOfDay - t.secondsOfDay) / st.SECONDS_PER_DAY
      )
    }),
  ...
  ;(Vt.prototype.cancel = function () {
    ...
    (Wt.prototype.pop = function (e) {
      ...
      const t = this._array,
        n = t[e]
      return (
        Ht(t, e, --this._length), this.heapify(e), (t[this._length] = void 0), n
      )
    })
  const Yt = {
  ...
  function rn(e) {
    return (
      e.state === jt.UNISSUED && ((e.state = jt.ISSUED), (e.deferred = Z())),
      e.deferred.promise
    )
  }
  function on(e) {
  ...
  function sn(e) {
    ...
    t &&
      (--Yt.numberOfActiveRequests,
      --Xt[e.serverKey],
      ++Yt.numberOfCancelledActiveRequests),
  ...
  ;(tn.maximumRequests = 50),
    ...
    (tn.serverHasOpenSlots = function (e, t) {
      ...
      const n = r.defaultValue(
        tn.requestsByServer[e],
        tn.maximumRequestsPerServer
      )
      return Xt[e] + t <= n
    }),
    ...
    (tn.update = function () {
      ...
      for (e = 0; e < r; ++e)
        (t = Jt[e]),
          t.cancelled && sn(t),
          t.state === jt.ACTIVE ? n > 0 && (Jt[e - n] = t) : ++n
      Jt.length -= n
      ...
      !(function () {
        ...
        0 === Yt.numberOfActiveRequests &&
          ...
          (Yt.numberOfAttemptedRequests > 0 &&
            (console.log(
              `Number of attempted requests: ${Yt.numberOfAttemptedRequests}`
            ),
            (Yt.numberOfAttemptedRequests = 0)),
          Yt.numberOfCancelledRequests > 0 &&
            (console.log(
              `Number of cancelled requests: ${Yt.numberOfCancelledRequests}`
            ),
            (Yt.numberOfCancelledRequests = 0)),
          ...
          Yt.numberOfFailedRequests > 0 &&
            (console.log(
              `Number of failed requests: ${Yt.numberOfFailedRequests}`
            ),
            (Yt.numberOfFailedRequests = 0)))
    ...
    (tn.request = function (e) {
      ...
      if (
        ...
        tn.throttleRequests &&
          e.throttleByServer &&
          !tn.serverHasOpenSlots(e.serverKey))
      )
        return
  ...
  ;(mn.createIfNeeded = function (e) {
    ...
    (mn.supportsImageBitmapOptions = function () {
      ...
      if ('function' != typeof createImageBitmap)
        return (gn = Promise.resolve(!1)), gn
      return (
        (gn = mn
          .fetchBlob({
    ...
    Object.defineProperties(mn.prototype, {
      ...
      isCrossOriginUrl: {
        get: function () {
          return (function (e) {
            r.defined(kt) || (kt = document.createElement('a')),
              (kt.href = window.location.href)
            const t = kt.host,
              n = kt.protocol
            return (
              (kt.href = e),
              (kt.href = kt.href),
              n !== kt.protocol || t !== kt.host
            )
          })(this._url)
        }
      },
    ...
    (mn.prototype.fetchImage = function (e) {
      ...
      if (
        (pn(this.request),
        !cn || this.isDataUri || this.isBlobUri || (!this.hasHeaders && !n))
      )
        return yn({
          resource: this,
          flipY: o,
  ...
  ;(mn.prototype.fetch = function (e) {
    ...
    (mn._Implementations.createImage = function (e, t, o, i, s, a) {
      ...
      mn.supportsImageBitmapOptions()
        .then(function (c) {
          if (!c || !a)
            return void mn._Implementations.loadImageElement(u, t, o)
          const l = Z(),
  ...
  ;(mn._Implementations.loadWithXhr = function (e, t, o, i, s, a, u) {
      ...
      (l.onload = function () {
        if ((l.status < 200 || l.status >= 300) && (!d || 0 !== l.status))
          return void a.reject(
            new Lt(l.status, l.response, l.getAllResponseHeaders())
          )
        const e = l.response,
          i = l.responseType
        if ('HEAD' === o || 'OPTIONS' === o) {
    ...
    (mn._DefaultImplementations.loadAndExecuteScript =
      mn._Implementations.loadAndExecuteScript),
    ...
    (Sn.prototype.compute = function (e, t) {
      ...
      if (
        (r.defined(t) || (t = new nt(0, 0, 0, 0, 0)),
  ...
  function Ln(e, t, n) {
    ...
    return (
      (r.dayNumber = t),
      (r.secondsOfDay = n),
      At.daysDifference(r, e._sampleZeroDateTT)
    )
  }
  function Qn(e, t) {
  ...
  ;(Bn.prototype.preload = function (e, t, n, r) {
    ...
    (Bn.prototype.computeXysRadians = function (e, t, n) {
      ...
      if (
        (r.defined(l[3 * a]) ||
          (Qn(this, (a / this._samplesPerXysFile) | 0), (c = !0)),
        r.defined(l[3 * u]) ||
          (Qn(this, (u / this._samplesPerXysFile) | 0), (c = !0)),
        c)
      )
        return
  ...
  ;($n.localFrameToFixedFrameGenerator = function (e, i) {
        ...
        : ((a = function (n, a, u) {
            if (
              ...
              t.Cartesian3.unpack(Hn[e], 0, Gn),
                'east' !== e &&
                  'west' !== e &&
                  t.Cartesian3.multiplyByScalar(Gn, r, Gn),
                t.Cartesian3.unpack(Hn[i], 0, Jn),
                'east' !== i &&
                  'west' !== i &&
                  t.Cartesian3.multiplyByScalar(Jn, r, Jn),
                t.Cartesian3.unpack(Hn[s], 0, Xn),
                'east' !== s &&
                  'west' !== s &&
                  t.Cartesian3.multiplyByScalar(Xn, r, Xn)
            } else {
    ...
    ($n.eastNorthUpToFixedFrame = $n.localFrameToFixedFrameGenerator(
      'east',
      'north'
    )),
    ($n.northEastDownToFixedFrame = $n.localFrameToFixedFrameGenerator(
      'north',
      'east'
    )),
    ($n.northUpEastToFixedFrame = $n.localFrameToFixedFrameGenerator(
      'north',
      'up'
    )),
    ($n.northWestUpToFixedFrame = $n.localFrameToFixedFrameGenerator(
      'north',
      'west'
    ))
  const Kn = new Ie(),
  ...
  ;($n.computeTemeToPseudoFixedMatrix = function (e, n) {
    ...
    a =
      s >= 43200
        ? (u + 0.5) / st.DAYS_PER_JULIAN_CENTURY
        : (u - 0.5) / st.DAYS_PER_JULIAN_CENTURY
    const c =
  ...
  $n.computeFixedToIcrfMatrix = function (e, n) {
    ...
    const p = t.Matrix3.fromRotationZ(-u.s, gr),
      ...
      g =
        (e.secondsOfDay - At.computeTaiMinusUtc(e) + i.ut1MinusUtc) /
        st.SECONDS_PER_DAY
  ...
  ;($n.pointToWindowCoordinates = function (e, t, n, r) {
    return (
      ((r = $n.pointToGLWindowCoordinates(e, t, n, r)).y = 2 * t[5] - r.y), r
    )
  }),
