define([
  ...
  function f(e, t) {
    const r = e.attributes,
      o = r.position,
      i = o.values.length / o.componentsPerAttribute
    r.batchId = new s.GeometryAttribute({
      componentDatatype: n.ComponentDatatype.FLOAT,
      componentsPerAttribute: 1,
      values: new Float32Array(i)
    })
    const c = r.batchId.values
    for (let e = 0; e < i; ++e) c[e] = t
  }
  function l(e) {
    const o = e.instances,
      s = e.projection,
      c = e.elementIndexUintSupported,
      d = e.scene3DOnly,
    ...
    if (
      ((function (e, t, n) {
        ...
        if (!o && s > 1) {
          ...
          for (c = 1; c < s; ++c)
            if (!i.Matrix4.equals(t, e[c].modelMatrix)) {
              o = !0
              break
            }
        }
        if (o)
          for (c = 0; c < s; ++c)
            r.defined(e[c].geometry) &&
              a.GeometryPipeline.transformToWorldCoordinates(e[c])
        else i.Matrix4.multiplyTransformation(t, e[0].modelMatrix, t)
      })(o, l, d),
      !d)
    )
      for (m = 0; m < g; ++m)
        r.defined(o[m].geometry) && a.GeometryPipeline.splitLongitude(o[m])
    if (
      ((function (e) {
        const t = e.length
        for (let n = 0; n < t; ++n) {
      ...
      for (m = 0; m < g; ++m) {
        ...
        r.defined(e.geometry)
          ? (a.GeometryPipeline.reorderForPostVertexCache(e.geometry),
            a.GeometryPipeline.reorderForPreVertexCache(e.geometry))
          : r.defined(e.westHemisphereGeometry) &&
            r.defined(e.eastHemisphereGeometry) &&
            (a.GeometryPipeline.reorderForPostVertexCache(
              e.westHemisphereGeometry
            ),
            a.GeometryPipeline.reorderForPreVertexCache(
              e.westHemisphereGeometry
            ),
            a.GeometryPipeline.reorderForPostVertexCache(
    ...
    let y = a.GeometryPipeline.combineInstances(o)
      ...
      if (d)
        for (const t in e)
          e.hasOwnProperty(t) &&
            ...
            a.GeometryPipeline.encodeAttribute(h, t, `${t}3DHigh`, `${t}3DLow`)
      else
        for (const o in e)
          if (
            e.hasOwnProperty(o) &&
            ...
            const e = `${o}3D`,
              n = `${o}2D`
            a.GeometryPipeline.projectTo2D(h, o, e, n, s),
              r.defined(h.boundingSphere) &&
                'position' === o &&
                (h.boundingSphereCV = t.BoundingSphere.fromVertices(
                  h.attributes.position2D.values
                )),
              a.GeometryPipeline.encodeAttribute(h, e, `${e}High`, `${e}Low`),
              a.GeometryPipeline.encodeAttribute(h, n, `${n}High`, `${n}Low`)
          }
      u && a.GeometryPipeline.compressVertices(h)
    }
    if (!c) {
      let e = []
      for (g = y.length, m = 0; m < g; ++m)
        (h = y[m]),
          (e = e.concat(a.GeometryPipeline.fitToUnsignedShortIndices(h)))
      y = e
    }
    return y
  }
  ...
  ;(h.combineGeometry = function (e) {
    ...
    s > 0 &&
      ((n = l(e)),
      n.length > 0 &&
        ((o = a.GeometryPipeline.createAttributeLocations(n[0])),
        e.createPickOffsets &&
          (c = (function (e, t) {
            const n = []
            return (
    ...
    (h.unpackCreateGeometryResults = function (e) {
      ...
      for (; u < o.length; ) {
        ...
        1 === o[u++] && (m = t.BoundingSphere.unpack(o, u)),
          (u += t.BoundingSphere.packedLength)
        const x = new c.GeometryAttributes(),
          G = o[u++]
        for (i = 0; i < G; i++) {
          const e = r[o[u++]],
            t = o[u++]
        ...
        if (((g = o[u++]), g > 0)) {
          const e = y.length / b
          for (S = d.IndexDatatype.createTypedArray(e, g), i = 0; i < g; i++)
            S[i] = o[u++]
        }
        a[p++] = new s.Geometry({
          primitiveType: e,
    ...
    (h.unpackCombineGeometryParameters = function (e) {
      const n = (function (e) {
          ...
          let o = 0,
            s = 1
          for (; s < t.length; ) {
            const e = i.Matrix4.unpack(t, s)
            let c
            ;(s += i.Matrix4.packedLength),
              r.defined(t[s]) &&
                (c = { offset: new u(t[s], t[s + 1], t[s + 2]) }),
              (s += 3),
              (n[o++] = { modelMatrix: e, attributes: c })
          }
          return n
        })(e.packedInstances),
      ...
      let c = 0
      for (let e = 0; e < s; e++) {
        const t = h.unpackCreateGeometryResults(o[e]),
          r = t.length
        for (let e = 0; e < r; e++) {
          const r = t[e]
          ;(n[c].geometry = r), ++c
      ...
      const a = i.Ellipsoid.clone(e.ellipsoid)
      return {
        instances: n,
        ellipsoid: a,
