define([
  ...
  'use strict'
  const c = new r.Cartesian3()
  let p = new r.Cartesian3()
  const f = new i.BoundingSphere(),
    m = new i.BoundingSphere()
  function h(e) {
    const t = (e = a.defaultValue(e, a.defaultValue.EMPTY_OBJECT)).center,
      i = a.defaultValue(e.ellipsoid, r.Ellipsoid.WGS84),
      o = e.semiMajorAxis,
      s = e.semiMinorAxis,
      l = a.defaultValue(e.granularity, n.CesiumMath.RADIANS_PER_DEGREE),
      u = a.defaultValue(e.height, 0),
      d = a.defaultValue(e.extrudedHeight, u)
  ...
  ;(h.unpack = function (e, t, i) {
    ...
    const n = r.Cartesian3.unpack(e, t, y)
    t += r.Cartesian3.packedLength
    const o = r.Ellipsoid.unpack(e, t, b)
    ...
    (h.createGeometry = function (e) {
      ...
      const o = e._height,
        h = e._extrudedHeight,
        y = !n.CesiumMath.equalsEpsilon(o, h, 0, n.CesiumMath.EPSILON2)
      ...
      if (y)
        (b.extrudedHeight = h),
          ...
          (A = (function (e) {
            const o = e.center,
              p = e.ellipsoid,
              h = e.semiMajorAxis
            let y = r.Cartesian3.multiplyByScalar(
              p.geodeticSurfaceNormal(o, c),
              e.height,
              c
            )
            ;(f.center = r.Cartesian3.add(o, y, f.center)),
              (f.radius = h),
              ...
              (m.radius = h)
            let b = s.EllipseGeometryLibrary.computeEllipsePositions(
              e,
              !1,
              !0
            ).outerPositions
            const A = new u.GeometryAttributes({
              position: new l.GeometryAttribute({
                componentDatatype: n.ComponentDatatype.DOUBLE,
                componentsPerAttribute: 3,
                values: s.EllipseGeometryLibrary.raisePositionsToHeight(
                  b,
                  e,
                  !0
                )
            ...
            b = A.position.values
            const _ = i.BoundingSphere.union(f, m)
            let g = b.length / 3
            if (a.defined(e.offsetAttribute)) {
              let i = new Uint8Array(g)
              if (e.offsetAttribute === t.GeometryOffsetAttribute.TOP)
                i = t.arrayFill(i, 1, 0, g / 2)
              else {
                const r =
                  e.offsetAttribute === t.GeometryOffsetAttribute.NONE ? 0 : 1
                i = t.arrayFill(i, r)
              }
            ...
            let x = a.defaultValue(e.numberOfVerticalLines, 16)
            x = n.CesiumMath.clamp(x, 0, g / 2)
        ...
        ((A = (function (e) {
          ...
          const a = new i.BoundingSphere(p, e.semiMajorAxis),
            o = s.EllipseGeometryLibrary.computeEllipsePositions(
              e,
              !1,
              !0
            ).outerPositions,
            ...
            f = o.length / 3,
            m = d.IndexDatatype.createTypedArray(f, 2 * f)
          let h = 0
        ...
        const i = A.attributes.position.values.length,
