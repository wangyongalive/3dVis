define([
  ...
  function v(e, t, o, r, n) {
    const p = l.EllipsoidTangentPlane.fromPoints(t, e).projectPointsOntoPlane(
      t,
      H
    )
    let g, m
  ...
  function x(o) {
    ...
    ;(this._ellipsoid = t.Ellipsoid.clone(n)),
      ...
      (this.packedLength =
        c.PolygonGeometryLibrary.computeHierarchyPackedLength(r) +
      ...
      if (
        ...
        for (A = 0; A < d.length; A++) {
          if (
            ...
            t._offsetAttribute === o.GeometryOffsetAttribute.TOP
              ...
              : ((E =
                  t._offsetAttribute === o.GeometryOffsetAttribute.NONE
                    ? 0
                    : 1),
                (i = o.arrayFill(i, E))),
        ...
        for (A = 0; A < d.length; A++) {
          if (
            ...
            ;(E =
              t._offsetAttribute === o.GeometryOffsetAttribute.NONE ? 0 : 1),
              o.arrayFill(i, E),
              (g.geometry.attributes.applyOffset = new s.GeometryAttribute({
                componentDatatype: a.ComponentDatatype.UNSIGNED_BYTE,
                componentsPerAttribute: 1,
