define([
  ...
  function h(n) {
    ...
    a instanceof u.PerspectiveFrustum
      ...
      : a instanceof u.OrthographicFrustum &&
        ((c = 1), (p = u.OrthographicFrustum.packedLength)),
      (this._frustumType = c),
  ...
  h.pack = function (n, a, i) {
    ...
    return (
      (a[i++] = o),
      0 === o
        ? (u.PerspectiveFrustum.pack(s, a, i),
          (i += u.PerspectiveFrustum.packedLength))
        : (u.OrthographicFrustum.pack(s, a, i),
          (i += u.OrthographicFrustum.packedLength)),
  ...
  return (
    (h.unpack = function (n, a, i) {
      ...
      let s
      0 === o
        ? ((s = u.PerspectiveFrustum.unpack(n, a, f)),
          (a += u.PerspectiveFrustum.packedLength))
        : ((s = u.OrthographicFrustum.unpack(n, a, l)),
          (a += u.OrthographicFrustum.packedLength))
